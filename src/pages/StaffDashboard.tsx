...
import { BookOpen, Calendar, LogOut, Clock, Users } from 'lucide-react';
...
const StaffDashboard = () => {
  ...
  const handleSaveSelection = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Subject selection saved and locked",
      });
